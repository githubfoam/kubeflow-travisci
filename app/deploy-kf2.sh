...
#https://github.com/kubeflow/examples/tree/master/demos/simple_pipeline
conda create -n kubeflow-demo-simple-pipeline  python=3.6 #Create a clean python environment for installing Kubeflow Pipelines
conda init
source activate kfp
